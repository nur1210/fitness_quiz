...
namespace MyProject
{
    public class DbPrograms
    {
        public static void AddProgram(TrainigProgram program)
        {
            ...
            MySqlHelper.ExecuteNonQuery(Connection.Conn, sql, new MySqlParameter[] { new MySqlParameter("Description", program.Description) });
        }
        ...
        public static void UpdateProgram(TrainigProgram program)
        {
            ...
            MySqlHelper.ExecuteNonQuery(Connection.Conn, sql, new MySqlParameter[] { new MySqlParameter("Description", program.Description), new MySqlParameter("ID", program.Description) });
        }

        public static void DeleteProgram(TrainigProgram program)
        {
            string sql = "DELETE FROM programs WHERE id = @ID";
            MySqlHelper.ExecuteNonQuery(Connection.Conn, sql, new MySqlParameter[] { new MySqlParameter("ID", program.ID) });
        }
