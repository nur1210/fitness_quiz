...
namespace MyProject
{
    public class DbUsers
    {
        public static void AddUser(User user)
        {
            ...
            MySqlHelper.ExecuteNonQuery(Connection.Conn, sql, new MySqlParameter[] {new MySqlParameter("FirstName", user.FirstName), new MySqlParameter("LastName", user.LastName), new MySqlParameter("Email", user.Email), new MySqlParameter("Password", Hashing.HashPassword(user.Password)), new MySqlParameter("IsAdmin", user.IsAdmin)});
        }
        ...
        public static void DeleteUser(User user)
        {
            ...
            MySqlHelper.ExecuteNonQuery(Connection.Conn, sql, new MySqlParameter[] { new MySqlParameter("ID", user.ID) });
        }
